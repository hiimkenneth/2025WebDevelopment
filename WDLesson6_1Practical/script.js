...
let meat_prices = [7.25,13,25,39];
let seafood_titles = ["Clams","Crabs","Lobster","Scallops","Shrimp","Tuna"];
let seafood = ["clams.png","crabs.jpg", "lobster.png", "scallops.jpg", "shrimp.jpg", "tuna.jpg"];
let seafood_prices = [21,30,27,30,15,17];
let dessert_titles = ["Flan", "Passionberry", "Oreocup"];
let dessert = ["flan.jpg","passionberry.jpeg","oreocup.jpg"];
let dessert_prices = [13,15,9];

...
let seafoods = [
  ...
  { title: "Scallops", image: "scallops.jpg", price: 30.99 },
  { title: "Shrimp", image: "shrimp.jpg", price: 15.99 },
  { title: "Tuna", image: "tuna.jpg", price: 17.99 },
  { title: "Clams", image: "clams.jpg", price: 21.99 },
];
// Challenge 6: Create an array of JSON where each JSON contains the title, a link to an image and price for each dessert.  
let desserts = [
  { title: "Oreo Cup", image: "oreocup.jpg", price: 8.99 },
  { title: "Flan", image: "flan.jpg", price: 13.99 },
  { title: "Passionberry", image: "passionberry.jpeg", price: 16.99 },
];
function displayMeats(){
  ...
  */
  ...
  for(let i = 0; i < meats.lengths; i += 1){
    let m = meats[i];
